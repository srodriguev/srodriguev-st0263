...
def add_symbolic_files():
    ...
    symbolic_files["file_01"] = "Contenido del archivo 1"
    symbolic_files["file_10"] = "Contenido del archivo 2"
    symbolic_files["file_11"] = "Contenido del archivo 3"
...
def serve():
    ...
    server.start()
    print("Servidor activo y escuchando en el puerto 5001...")
